...
valid_url = "https://storage.googleapis.com/learning-datasets/validation-horse-or-human.zip"

# 저장할 파일 이름
train_zip = "horse-or-human_training.zip"
valid_zip = "horse-or-human_validation.zip"
